...
public class Silly implements Comparable<Silly>{
     ...
     */
    /** Creates a new Silly object.
     * This constructor takes in two String objects as an argument.
     * @param s1 the first part of the name of this Silly instance.
     * @param s2 the second part of the name of this Silly instance.
     */
